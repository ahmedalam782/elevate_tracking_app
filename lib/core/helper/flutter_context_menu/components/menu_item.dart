...
const double kMenuItemHeight = 45.0;
...
final class MenuItem<T> extends ContextMenuItem<T> {
  final Widget? icon;
  final Widget? label;
  final Widget? replaceItemWidget;
  ...
  Widget builder(
    ...
    final background = backgroundColor ?? context.colorScheme.surface;
    ...
    final disabledTextColor = context.colorScheme.onSurface.withValues(
      alpha: 0.2,
    );
