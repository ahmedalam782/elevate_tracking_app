/// Unified size constants for the entire app
/// Use AppSize for all numeric dimensions: padding, margin, gap, width, height, radius, font sizes, etc.
